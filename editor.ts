import { parseImagesResponse, MappedImage, Circle, Point } from "./types.js";
...
class EditImage {
    ...
    constructor(public image: MappedImage, parent: HTMLElement) {
        ...
        let drag: [Point, DOMRect] | null = null;
        this.img.addEventListener("mousedown", (event: MouseEvent) => {
        ...
        this.img.addEventListener("mouseleave", (event: MouseEvent) => {
            drag = null;
        });
    }

    addDot(circle: Circle) {
